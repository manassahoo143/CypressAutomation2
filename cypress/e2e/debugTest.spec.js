...
describe("Conduit", ()=> {
    ...
    it("SignUp", ()=> {
        ...
        cy.get("input[placeholder='Password']").type(randomUserId()+'4919973');
    ...
    it("New post and verify", ()=> {
        ...
        cy.get("input[placeholder='Article Title']").type("DemoTest@123494#!");
        cy.get("#main > div > div > div > div > div > form > fieldset > fieldset:nth-child(2) > input").type(randomUserId());
        cy.get("#main > div > div > div > div > div > form > fieldset > fieldset:nth-child(3) > textarea").type("CavTestDebugTestCasess");
